...
export function analyzeUPITransactions(transactions) {
  ...
  const totalCredit = validTransactions.reduce((sum, txn) => sum + (txn.type === 'credit' ? txn.amount : 0), 0);
  const totalDebit = validTransactions.reduce((sum, txn) => sum + (txn.type === 'debit' ? txn.amount : 0), 0);
